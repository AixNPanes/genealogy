...
public class HeaderDateStructure extends GedRecord
{
    ...
    public HeaderDateStructure() {}
    
    public HeaderDateStructure(Node node)
    {
    	super(node);
		...
		for(int i = 0; i < nodeList.getLength(); i ++)
		{
			...
			if ("TIME".equals(childNode.getNodeName()))
				this.setDateTime((Util.getNodeValue(childNode)));
