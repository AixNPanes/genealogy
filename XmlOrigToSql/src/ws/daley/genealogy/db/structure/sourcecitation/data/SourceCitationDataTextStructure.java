package ws.daley.genealogy.db.structure.sourcecitation.data;
...
public class SourceCitationDataTextStructure extends GedRecord
{
    private static final long serialVersionUID = 1L;

	public SourceCitationDataTextStructure() {}
    
    public SourceCitationDataTextStructure(Node node)
    {
    	super(node);
