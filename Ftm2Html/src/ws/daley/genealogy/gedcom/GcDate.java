...
public class GcDate extends GcBaseElement
{
    ...
    public boolean interpret() {
		this.date = getParameters();
		if (this.date.length() == 0)
			throw new RuntimeException("Date line missing date info");
		...
		for(IGcBaseElement e:this.elements)
		{
			...
			{
				case TAG_TIME:
					this.gcTime = new GcTimeLine(e);
					this.gcTime.interpret();
					newElements.add(this.gcTime);
					break;
				default:
					return false;
			}
