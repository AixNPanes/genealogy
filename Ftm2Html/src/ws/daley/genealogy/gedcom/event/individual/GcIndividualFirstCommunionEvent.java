...
public class GcIndividualFirstCommunionEvent extends Gc_IndividualEventStructureEvent
{
	public GcIndividualFirstCommunionEvent(GcBaseElement e, Vector<GcBaseElement> _vector)
	{
		super(e, "FCOM", null, null, _vector);
	}
}
