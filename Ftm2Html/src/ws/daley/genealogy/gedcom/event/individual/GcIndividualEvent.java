...
public class GcIndividualEvent extends Gc_IndividualEventStructureEvent
{
	...
	public GcIndividualEvent(GcBaseElement e, Vector<GcBaseElement> _vector)
	{
		super(e, "EVEN",  null, map, _vector);
	}
}
