...
public class GcIndividualNaturalizationEvent extends Gc_IndividualEventStructureEvent
{
	public GcIndividualNaturalizationEvent(GcBaseElement e, Vector<GcBaseElement> _vector)
	{
		super(e, "NATU", null, null, _vector);
	}
}
