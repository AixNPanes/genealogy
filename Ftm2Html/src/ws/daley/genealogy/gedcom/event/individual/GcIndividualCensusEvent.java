...
public class GcIndividualCensusEvent extends Gc_IndividualEventStructureEvent
{
	public GcIndividualCensusEvent(GcBaseElement e, Vector<GcBaseElement> _vector)
	{
		super(e, "CENS", null, null, _vector);
	}
}
