...
public class GcIndividualAdultChristeningEvent extends Gc_IndividualEventStructureEvent
{
	public GcIndividualAdultChristeningEvent(GcBaseElement e, Vector<GcBaseElement> _vector)
	{
		super(e, "CHRA", null, null, _vector);
	}
}
