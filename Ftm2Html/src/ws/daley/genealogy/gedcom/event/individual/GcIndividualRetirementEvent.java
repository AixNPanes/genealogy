...
public class GcIndividualRetirementEvent extends Gc_IndividualEventStructureEvent
{
	public GcIndividualRetirementEvent(GcBaseElement e, Vector<GcBaseElement> _vector)
	{
		super(e, "RETI", null, null, _vector);
	}
}
