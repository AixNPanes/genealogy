...
public class GcIndividualWillEvent extends Gc_IndividualEventStructureEvent
{
	public GcIndividualWillEvent(GcBaseElement e, Vector<GcBaseElement> _vector)
	{
		super(e, "BIRT", null, null, _vector);
	}
}
