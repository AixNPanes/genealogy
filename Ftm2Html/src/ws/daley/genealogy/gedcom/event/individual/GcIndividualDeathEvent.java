...
public class GcIndividualDeathEvent extends Gc_IndividualEventStructureEvent
{
	public GcIndividualDeathEvent(GcBaseElement e, Vector<GcBaseElement> _vector)
	{
		super(e, "DEAT", null, null, _vector);
	}
}
