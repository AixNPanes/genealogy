...
public class GcIndividualBlessingEvent extends Gc_IndividualEventStructureEvent
{
	public GcIndividualBlessingEvent(GcBaseElement e, Vector<GcBaseElement> _vector)
	{
		super(e, "BLES", null, null, _vector);
	}
}
