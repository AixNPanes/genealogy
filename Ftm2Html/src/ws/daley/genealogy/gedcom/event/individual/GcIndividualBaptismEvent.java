...
public class GcIndividualBaptismEvent extends Gc_IndividualEventStructureEvent
{
	public GcIndividualBaptismEvent(GcBaseElement e, Vector<GcBaseElement> _vector)
	{
		super(e, "BAPM", null, null, _vector);
	}
}
