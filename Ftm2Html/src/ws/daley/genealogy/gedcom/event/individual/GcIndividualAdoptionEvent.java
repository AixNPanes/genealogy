...
import ws.daley.genealogy.gedcom.link.GcFamilyChildAdoptionLink;
...
public class GcIndividualAdoptionEvent extends Gc_IndividualEventStructureEvent
{
	private static TagDescriptorMap map = new TagDescriptorMap();
	
	static{
		map = TagDescriptorMap.newFromArray(new TagDescriptor[]{
				new TagDescriptor("FAMC", 0, 1, GcFamilyChildAdoptionLink.class)
		});
	}

	public GcIndividualAdoptionEvent(GcBaseElement e, Vector<GcBaseElement> _vector)
	{
		super(e, "ADOP", null, map, _vector);
	}
}
