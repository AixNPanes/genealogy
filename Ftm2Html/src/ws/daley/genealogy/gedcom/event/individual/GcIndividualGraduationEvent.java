...
public class GcIndividualGraduationEvent extends Gc_IndividualEventStructureEvent
{
	public GcIndividualGraduationEvent(GcBaseElement e, Vector<GcBaseElement> _vector)
	{
		super(e, "GRAD", null, null, _vector);
	}
}
