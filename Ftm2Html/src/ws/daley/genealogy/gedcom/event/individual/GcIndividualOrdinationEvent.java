...
public class GcIndividualOrdinationEvent extends Gc_IndividualEventStructureEvent
{
	public GcIndividualOrdinationEvent(GcBaseElement e, Vector<GcBaseElement> _vector)
	{
		super(e, "ORDN", null, null, _vector);
	}
}
