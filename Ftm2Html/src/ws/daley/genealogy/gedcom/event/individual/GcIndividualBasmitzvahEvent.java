...
public class GcIndividualBasmitzvahEvent extends Gc_IndividualEventStructureEvent
{
	public GcIndividualBasmitzvahEvent(GcBaseElement e, Vector<GcBaseElement> _vector)
	{
		super(e, "BASM", null, null, _vector);
	}
}
