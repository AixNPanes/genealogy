...
public class GcIndividualEmigrationEvent extends Gc_IndividualEventStructureEvent
{
	public GcIndividualEmigrationEvent(GcBaseElement e, Vector<GcBaseElement> _vector)
	{
		super(e, "EMIG", null, null, _vector);
	}
}
