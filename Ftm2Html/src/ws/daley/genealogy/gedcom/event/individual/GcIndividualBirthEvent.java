...
public class GcIndividualBirthEvent extends Gc_IndividualEventStructureEvent
{
	...
	public GcIndividualBirthEvent(GcBaseElement e, Vector<GcBaseElement> _vector)
	{
		super(e, "BIRT", null, map, _vector);
	}
}
