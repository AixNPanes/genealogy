...
public class GcIndividualImmigrationEvent extends Gc_IndividualEventStructureEvent
{
	public GcIndividualImmigrationEvent(GcBaseElement e, Vector<GcBaseElement> _vector)
	{
		super(e, "IMMI",  null, null, _vector);
	}
}
