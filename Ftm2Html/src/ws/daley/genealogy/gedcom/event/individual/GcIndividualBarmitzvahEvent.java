...
public class GcIndividualBarmitzvahEvent extends Gc_IndividualEventStructureEvent
{
	public GcIndividualBarmitzvahEvent(GcBaseElement e, Vector<GcBaseElement> _vector)
	{
		super(e, "BARM", null, null, _vector);
	}
}
