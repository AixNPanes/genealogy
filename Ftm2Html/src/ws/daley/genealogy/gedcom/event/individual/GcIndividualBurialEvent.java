...
public class GcIndividualBurialEvent extends Gc_IndividualEventStructureEvent
{
	public GcIndividualBurialEvent(GcBaseElement e, Vector<GcBaseElement> _vector)
	{
		super(e, "BURI", null, null, _vector);
	}
}
