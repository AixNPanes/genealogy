...
public class GcIndividualProbateEvent extends Gc_IndividualEventStructureEvent
{
	public GcIndividualProbateEvent(GcBaseElement e, Vector<GcBaseElement> _vector)
	{
		super(e, "PROB", null, null, _vector);
	}
}
