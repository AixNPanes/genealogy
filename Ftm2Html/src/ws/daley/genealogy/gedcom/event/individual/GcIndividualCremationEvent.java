...
public class GcIndividualCremationEvent extends Gc_IndividualEventStructureEvent
{
	public GcIndividualCremationEvent(GcBaseElement e, Vector<GcBaseElement> _vector)
	{
		super(e, "CREM", null, null, _vector);
	}
}
