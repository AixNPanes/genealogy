...
import ws.daley.genealogy.gedcom.link.GcFamilyChildLink;
...
public class GcIndividualChristeningEvent extends Gc_IndividualEventStructureEvent
{
	private static TagDescriptorMap map = new TagDescriptorMap();
	
	static{
		map = TagDescriptorMap.newFromArray(new TagDescriptor[]{
				new TagDescriptor("FAMC", 0, 1, GcFamilyChildLink.class)
		});
	}
	
	public GcIndividualChristeningEvent(GcBaseElement e, Vector<GcBaseElement> _vector)
	{
		super(e, "CHR", null, map, _vector);
	}
}
