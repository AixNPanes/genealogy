...
public class GcFamilyMarriageSettlementEvent extends Gc_FamilyEventStructureEvent
{
	public GcFamilyMarriageSettlementEvent(GcBaseElement e, Vector<GcBaseElement> _vector) {
		super(e, "MARS", null, null, _vector);
	}
