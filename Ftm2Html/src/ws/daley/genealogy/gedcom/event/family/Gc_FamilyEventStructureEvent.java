...
import ws.daley.genealogy.gedcom.attribute.GcYOrNullAttribute;
...
import ws.daley.genealogy.gedcom.line.GcDateFamilyEventLine;
import ws.daley.genealogy.gedcom.line.GcFamilyEventTypeLine;
...
public abstract class Gc_FamilyEventStructureEvent extends Gc_Event
{
//	public String parameters;
	private static TagDescriptorMap tagDescriptorMap = new TagDescriptorMap();
	@SuppressWarnings("hiding")
    public static AttributeDescriptorMap attributeDescriptorMap = new AttributeDescriptorMap();
	
	static{
		tagDescriptorMap = TagDescriptorMap.newFromArray(new TagDescriptor[]{
				new TagDescriptor("TYPE", 0, 1, GcFamilyEventTypeLine.class),
				new TagDescriptor("DATE", 0, 1, GcDateFamilyEventLine.class),
				...
				new TagDescriptor("CITE", 0, 1, GcSourceCitationStructure.class),
		...
		attributeDescriptorMap = AttributeDescriptorMap.newFromArray(
				new AttributeDescriptor("Y_OR_NULL", 0, 1, GcYOrNullAttribute.class)
		);
	}

	public Gc_FamilyEventStructureEvent() {}
	
	public Gc_FamilyEventStructureEvent(GcBaseElement e, String _type, AttributeDescriptorMap _attributeDescriptorMap, TagDescriptorMap _tagDescriptorMap, Vector<GcBaseElement> _vector)
	{
		super(e, _type, AttributeDescriptorMap.newFromArray(attributeDescriptorMap, _attributeDescriptorMap), TagDescriptorMap.newFromArray(tagDescriptorMap, _tagDescriptorMap), _vector);
	}
