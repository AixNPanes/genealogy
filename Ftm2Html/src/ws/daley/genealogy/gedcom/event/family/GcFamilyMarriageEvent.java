...
public class GcFamilyMarriageEvent extends Gc_FamilyEventStructureEvent
{
	public GcFamilyMarriageEvent(GcBaseElement e, Vector<GcBaseElement> _vector)
	{
		super(e, "MARR", null, null, _vector);
	}
}
