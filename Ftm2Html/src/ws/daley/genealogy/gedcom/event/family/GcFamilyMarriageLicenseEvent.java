...
public class GcFamilyMarriageLicenseEvent extends Gc_FamilyEventStructureEvent
{
	public GcFamilyMarriageLicenseEvent(GcBaseElement e, Vector<GcBaseElement> _vector)
	{
		super(e, "MARL", null, null, _vector);
	}
