...
public class GcFamilyEngagementEvent extends Gc_FamilyEventStructureEvent
{
	public GcFamilyEngagementEvent(GcBaseElement e, Vector<GcBaseElement> _vector)
	{
		super(e, "ENGA", null, null, _vector);
	}
}
