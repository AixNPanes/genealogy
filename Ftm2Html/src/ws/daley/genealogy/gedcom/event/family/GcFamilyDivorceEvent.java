...
public class GcFamilyDivorceEvent extends Gc_FamilyEventStructureEvent
{
	public GcFamilyDivorceEvent(GcBaseElement e, Vector<GcBaseElement> _vector)
	{
		super(e, "DIV", null, null, _vector);
	}
}
