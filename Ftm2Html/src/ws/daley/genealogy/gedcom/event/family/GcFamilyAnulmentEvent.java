...
public class GcFamilyAnulmentEvent extends Gc_FamilyEventStructureEvent
{
	public GcFamilyAnulmentEvent(GcBaseElement e, Vector<GcBaseElement> _vector)
	{
		super(e, "ANUL", null, null, _vector);
	}
}
