...
public class GcFamilyMarriageContractEvent extends Gc_FamilyEventStructureEvent
{
	public GcFamilyMarriageContractEvent(GcBaseElement e, Vector<GcBaseElement> _vector)
	{
		super(e, "MARC", null, null, _vector);
	}
