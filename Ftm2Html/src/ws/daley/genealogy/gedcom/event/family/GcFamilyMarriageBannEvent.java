...
public class GcFamilyMarriageBannEvent extends Gc_FamilyEventStructureEvent
{
	public GcFamilyMarriageBannEvent(GcBaseElement e, Vector<GcBaseElement> _vector)
	{
		super(e, "MARB", null, null, _vector);
	}
}
