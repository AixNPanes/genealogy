...
public class GcIndividualSealingChildOrdinanceStructure extends Gc_Structure
{
	...
	public GcIndividualSealingChildOrdinanceStructure(GcBaseElement e, Vector<GcBaseElement> _vector)
	{
		super(e, "SLGC", null, map, _vector);
	}
};
