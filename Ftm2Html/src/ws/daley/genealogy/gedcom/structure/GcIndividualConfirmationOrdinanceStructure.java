...
public class GcIndividualConfirmationOrdinanceStructure extends Gc_Structure
{
	public String data;
	...
	public GcIndividualConfirmationOrdinanceStructure(GcBaseElement e, Vector<GcBaseElement> _vector)
	{
		super(e, "CONL", null, map, _vector);
	}
};
