...
public class GcIndividualEndowmentOrdinanceStructure extends Gc_Structure
{
	public String data;
	...
	public GcIndividualEndowmentOrdinanceStructure(GcBaseElement e, Vector<GcBaseElement> _vector)
	{
		super(e, "ENDL", null, map, _vector);
	}
};
