...
public class GcIndividualOrdinanceStructure extends Gc_Structure
{
	public String data;
	...
	static{
		...
		attributeDescriptorMap = AttributeDescriptorMap.newFromArray(new AttributeDescriptor[]{
				new AttributeDescriptor("NAME_OF_SOURCE_DATA", 1, 1, GcNameOfSourceDataAttribute.class)
		});
	}
	
	public GcIndividualOrdinanceStructure(GcBaseElement e, Vector<GcBaseElement> _vector)
	{
