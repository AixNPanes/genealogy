...
public class GcMultimediaLinkXrefStructure extends Gc_Xref
{
	public GcMultimediaLinkXrefStructure(GcBaseElement e, Vector<GcBaseElement> _vector)
	{
		super(e, "OBJE", null, null, _vector);
	}
};
