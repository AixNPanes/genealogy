...
public class GcSourceCitationStructure extends Gc_CombinationStructure
{
	public GcSourceCitationStructure(GcBaseElement e, Vector<GcBaseElement> _vector)
	{
		try {
			setStructure(new GcSourceCitationXrefStructure(e, _vector));
			return;
		} catch(Throwable t)
		{
		}
		setStructure(new GcSourceCitationDescriptionStructure(e, _vector));
	}
};
