...
public class GcIndividualOccupationAttribute extends Gc_AttributeIndividual
{
	public GcIndividualOccupationAttribute(GcBaseElement e) {
		super(e, "OCCU", null, null, null);
	}
