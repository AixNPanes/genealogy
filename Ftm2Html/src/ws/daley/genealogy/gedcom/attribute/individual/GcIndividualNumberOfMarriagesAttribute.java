...
public class GcIndividualNumberOfMarriagesAttribute extends Gc_AttributeIndividual
{
	public GcIndividualNumberOfMarriagesAttribute(GcBaseElement e) {
		super(e, "NMR", null, null, null);
	}
