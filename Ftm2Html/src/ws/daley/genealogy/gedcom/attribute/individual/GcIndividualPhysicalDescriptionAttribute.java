...
public class GcIndividualPhysicalDescriptionAttribute extends Gc_AttributeIndividual
{
	public GcIndividualPhysicalDescriptionAttribute(GcBaseElement e) {
		super(e, "DESC", null,  null, null);
	}
