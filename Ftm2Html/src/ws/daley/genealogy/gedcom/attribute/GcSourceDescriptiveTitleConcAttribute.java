...
public class GcSourceDescriptiveTitleConcAttribute extends Gc_Attribute
{
	public static AttributeDescriptorMap map = new AttributeDescriptorMap();
	
	static{
		map = AttributeDescriptorMap.newFromArray(new AttributeDescriptor[]{
				new AttributeDescriptor("SOURCE_TITLE", 1, 248, GcSourceDescriptiveTitleConcAttribute.class),
		});
	}
