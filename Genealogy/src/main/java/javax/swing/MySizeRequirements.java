 ...
 * that take arrays of MySizeRequirements as arguments.
 * The MySizeRequirements class supports two types of layout:
 *
 * <blockquote>
 * <dl>
 * <dt> tiled
 ...
 * <p>
 *
 * Each MySizeRequirements object contains information
 ...
 */
public class MySizeRequirements implements Serializable {
    ...
    /**
     * Creates a MySizeRequirements object with the minimum, preferred,
     * and maximum sizes set to zero and an alignment value of 0.5
     * (centered).
     */
    public MySizeRequirements() {
        minimum = 0;
        preferred = 0;
        maximum = 0;
        alignment = 0.5f;
    ...
    /**
     * Creates a MySizeRequirements object with the specified minimum, preferred,
     ...
     */
    public MySizeRequirements(int min, int pref, int max, float a) {
        minimum = min;
        preferred = pref;
        maximum = max;
     ...
     * passed-in MySizeRequirements array.
     * The returned MySizeRequirements object has an alignment of 0.5
     ...
     *   default MySizeRequirements object instance being passed back.
     * @return  the total space requirements.
     */
    public static MySizeRequirements getTiledSizeRequirements(MySizeRequirements[]
                                                            children) {
        MySizeRequirements total = new MySizeRequirements();
        for (int i = 0; i < children.length; i++) {
            MySizeRequirements req = children[i];
     ...
     * of each component in the set are represented by an entry in the
     * passed-in MySizeRequirements array.  The total space required will
     * never be more than Integer.MAX_VALUE.
     *
     * @param children  the set of child requirements.  If of zero length,
     *  the returns result will be a default instance of MySizeRequirements.
     * @return  the total space requirements.
     */
    public static MySizeRequirements getAlignedSizeRequirements(MySizeRequirements[]
                                                              children) {
        MySizeRequirements totalAscent = new MySizeRequirements(0, 0, 0, 0);
        MySizeRequirements totalDescent = new MySizeRequirements(0, 0, 0, 0);
        for (int i = 0; i < children.length; i++) {
            MySizeRequirements req = children[i];
        ...
        return new MySizeRequirements(min, pref, max, alignment);
    }
     ...
     * (specified as an array of MySizeRequirements), and
    ...
    public static void calculateTiledPositions(int allocated,
                                               MySizeRequirements total,
                                               MySizeRequirements[] children,
                                               int[] offsets,
                                               int[] spans) {
    ...
    private static void compressedTile(int allocated, long min, long pref, long max,
        ...
        if( forward ) {
            ...
            for (int i = 0; i < spans.length; i++) {
                ...
                MySizeRequirements req = request[i];
     ...
     * @param children  an array of MySizeRequirements objects
     * @return an array of ints containing the final size for each item
     */
    public static int[] adjustSizes(int delta, MySizeRequirements[] children) {
      return new int[0];
    }
}
