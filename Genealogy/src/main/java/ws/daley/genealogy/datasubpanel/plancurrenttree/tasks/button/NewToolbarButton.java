...
public class NewToolbarButton extends MyTasksToolbarButton
{
	private static final Logger log = ((LoggerContext)LoggerFactory.getILoggerFactory()).getLogger(NewToolbarButton.class);

	private static File activeIconFile = new File(toolbarIconFolder, "new_hover.png");
	private static File inactiveIconFile = new File(toolbarIconFolder, "new_inactive.png");
	private static File hoverIconFile = new File(toolbarIconFolder, "new_hover.png");
