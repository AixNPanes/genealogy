...
public class PlacesPlacesPane extends MyPane implements RefreshData
{
	private static final Logger log = ((LoggerContext)LoggerFactory.getILoggerFactory()).getLogger(PlacesPlacesPane.class);

	public PlacesPlacesPane()
	{
		super("Places", null, null);
		log.trace("Entering");
	}
