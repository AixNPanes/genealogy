...
public class PeoplePersonPane extends MyPane implements RefreshData
{
	private static final Logger log = ((LoggerContext)LoggerFactory.getILoggerFactory()).getLogger(PeoplePersonPane.class);

	public PeoplePersonPane()
	{
		super("Person", null, null);
		log.trace("Entering");
	}
