...
public class PublishDetailPane extends MyPane implements RefreshData
{
	private static final Logger log = ((LoggerContext)LoggerFactory.getILoggerFactory()).getLogger(PublishDetailPane.class);

	public PublishDetailPane()
	{
