...
public class PeopleTreePane extends MyPane implements RefreshData
{
	private static final Logger log = ((LoggerContext)LoggerFactory.getILoggerFactory()).getLogger(PeopleTreePane.class);

	public PeopleTreePane()
	{
