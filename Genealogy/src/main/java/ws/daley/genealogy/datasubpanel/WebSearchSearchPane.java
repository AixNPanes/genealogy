...
public class WebSearchSearchPane extends MyPane implements RefreshData
{
	private static final Logger log = ((LoggerContext)LoggerFactory.getILoggerFactory()).getLogger(WebSearchSearchPane.class);

	public WebSearchSearchPane()
	{
