...
public class FilterToolbarButton extends MyTasksToolbarButton
{
	private static final Logger log = ((LoggerContext)LoggerFactory.getILoggerFactory()).getLogger(FilterToolbarButton.class);

	private static File activeIconFile = new File(toolbarIconFolder, "filter_hover.png");
	private static File inactiveIconFile = new File(toolbarIconFolder, "filter_inactive.png");
	private static File hoverIconFile = new File(toolbarIconFolder, "filter_hover.png");
