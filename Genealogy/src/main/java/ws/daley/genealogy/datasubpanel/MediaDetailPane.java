...
public class MediaDetailPane extends MyPane implements RefreshData
{
	private static final Logger log = ((LoggerContext)LoggerFactory.getILoggerFactory()).getLogger(MediaDetailPane.class);

	public MediaDetailPane()
	{
