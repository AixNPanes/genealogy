...
public class MediaCollectionPane extends MyPane implements RefreshData
{
	private static final Logger log = ((LoggerContext)LoggerFactory.getILoggerFactory()).getLogger(MediaCollectionPane.class);

	public MediaCollectionPane()
	{
