...
public class SourcesSourcesPane extends MyPane implements RefreshData
{
	private static final Logger log = ((LoggerContext)LoggerFactory.getILoggerFactory()).getLogger(SourcesSourcesPane.class);

	public SourcesSourcesPane()
	{
