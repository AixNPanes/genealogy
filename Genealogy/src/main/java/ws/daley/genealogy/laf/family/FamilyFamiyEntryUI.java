...
public class FamilyFamiyEntryUI extends BasicToolBarUI
{
	JToolBar b;
	/**
	...
	{
		JToolBar tb = (JToolBar) FamilyFamiyEntryUI.findRegisteredComponentOfType(c, JToolBar.class);
