...
/**
 * The default theme for the {@code FamilyLookAndFeel}.
 * <p>
 * The designers of the Family Look and Feel strive to keep the default look up
 ...
 * 
 * <p>
 * All colors returned by {@code FamilyOceanTheme} are completely opaque.
 *
 * @since 1.5
 * @see FamilyLookAndFeel#setCurrentTheme
 */
public class FamilyOceanTheme extends DefaultFamilyTheme
{
	...
	/**
	 * Creates an instance of <code>FamilyOceanTheme</code>
	 */
	public FamilyOceanTheme()
	{}
	...
	{
		Object focusBorder = new SwingLazyValue("javax.swing.plaf.BorderUIResource$LineBorderUIResource", new Object[] { getPrimary1() });
		...
		@SuppressWarnings("rawtypes")
		java.util.List sliderGradient = Arrays.asList( new Object[] { new Float(.3f), new Float(.2f), c8ddf2, getWhite(), new ColorUIResource(SECONDARY2) });
		...
		Object[] defaults = new Object[] {
			...
			"MenuBar.gradient", Arrays.asList(new Object[] { new Float(1f), new Float(0f), getWhite(), dadada, new ColorUIResource(dadada) }),
			...
			"InternalFrame.closeIcon", new UIDefaults.LazyValue()
			{
			    ...
			    @Override
			    public Object createValue(@SuppressWarnings("hiding") UIDefaults table)
			    {
			...
			"MenuBarUI", "ws.daley.genealogy.laf.family.FamilyMenuBarUI",
			...
			"Tree.expandedIcon", getIconResource("icons/ocean/expanded.gif"), 
	...
	{
		return SwingUtilities2.makeIcon(getClass(), FamilyOceanTheme.class, iconID);
	}
