...
/**
 * {@code FamilyTheme} provides the color palette and fonts used by the Java
 * Look and Feel.
 * <p>
 * {@code FamilyTheme} is abstract, see {@code DefaultFamilyTheme} and
 * {@code FamilyOceanTheme} for concrete implementations.
 * <p>
 * {@code FamilyLookAndFeel} maintains the current theme that the the
 * {@code ComponentUI} implementations for family use. Refer to
 * {@link FamilyLookAndFeel#setCurrentTheme
 * FamilyLookAndFeel.setCurrentTheme(FamilyTheme)} for details on changing the
 * current theme.
 * <p>
 * {@code FamilyTheme} provides a number of public methods for getting colors.
 ...
 * <p>
 * Concrete implementations of {@code FamilyTheme} must return {@code non-null}
 ...
 * @author Steve Wilson
 */
public abstract class FamilyTheme
{
	 ...
	 *
	 * @see FamilyLookAndFeel#getDefaults
	 */
	public void addCustomEntriesToTable(UIDefaults table)
	{}

	/**
	 * This is invoked when a FamilyLookAndFeel is installed and about to start
	 * using this theme. When we can add API this should be nuked in favor of
	 * DefaultFamilyTheme overriding addCustomEntriesToTable.
	 */
	void install()
	{}
